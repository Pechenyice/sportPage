var programmsParallaxArea = document.getElementById('programmsName');
programmsParallaxArea.addEventListener('mouseover', programmsCursorParallax);
programmsParallaxArea.addEventListener('mousemove', programmsCursorParallax);

function programmsCursorParallax(event) {
...
function dayNightChanger() {
    ...
    if (document.getElementById('programmsName').getBoundingClientRect().top - document.body.clientHeight <= 0) {
        document.getElementById('programmsName').style.backgroundColor = 'rgb(39,39,39)';
    ...
    if (document.getElementById('programmsName').getBoundingClientRect().top - document.body.clientHeight >= -699) {
        document.getElementById('programmsName').style.backgroundColor = 'rgb(237,237,237)';
    ...
    if (document.getElementById('programmsName').getBoundingClientRect().top - document.body.clientHeight <= 0 && document.getElementById('programmsName').getBoundingClientRect().top - document.body.clientHeight >= -700) {
        heightOst = 700 + document.getElementById('programmsName').getBoundingClientRect().top - document.body.clientHeight;
        var backColorConnect = Math.floor(39 + heightOst / 2.95);
        document.getElementById('programmsName').style.backgroundColor = 'rgb('+backColorConnect+','+backColorConnect+','+backColorConnect+')';
